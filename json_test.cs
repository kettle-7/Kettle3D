...
public class Component {
    ...
    public Component(string name) {
        this.Name = name;
        this.Location = new ComponentFile().appdata + @"Kettle3D\" + name;
...
public class ComponentFile {
    ...
    public dump() {
        ...
        foreach (var thing in this.Components) {
...
static void Main()
{
    Component[] comps = new Component[] {// name, location, url, version
    new Component(@"Kettle3D_Data/Resources/unity default resources", this.appdata + @"\Kettle3D\Kettle3D_Data\Resources\unity default resources", "https://raw.githubusercontent.com/Kettle3D/Kettle3D/C%23/game/Kettle3D_Data/Resources/unity%20default%20resources", 1),
