# Kettle3D Launcher v1.0, tilde faces are NOT a fashion statement anymore :~)
...
if not {"path" : "versions/d2005a.py", "version" : 6} in files["txt"]:
	downloadfile = txtfile(path='versions/d2005a.py', version=6)
