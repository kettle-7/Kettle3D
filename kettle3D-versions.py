# Kettle3D Launcher v1.0, tilde faces are apparently a fashion statement now :~)
...
if not {"path" : "versions/d2005a.py", "version" : 7} in files["txt"]:
	downloadfile = txtfile(path='versions/d2005a.py', version=7)
